...
console.log(`[MIDI_DEBUG] syncRoutesToMain: syncing ${routeList.length} routes`);
...
- [src/views/waterfallpiano/__tests__/](file:///f:/Codes/MIDI-JAR-NEW/src/views/waterfallpiano/__tests__) (3 处测试文件)
