<template>
  <SettingsCollapse :title="t('WaterfallPiano.midiFile')" :default-open="true">
    <SettingsRange
...
defineProps<{
  settings: MidiFileConfig;
}>();

const emit = defineEmits<{
  (e: "update", key: keyof MidiFileConfig, value: unknown): void;
}>();
