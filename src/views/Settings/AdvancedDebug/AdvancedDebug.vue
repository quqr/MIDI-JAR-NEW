    ...
    <div class="grid grid-cols-1 gap-4 m-4">
      ...
      >
        ...
        <SettingsToggle
          ...
          @update:model-value="
            updateNotationDisplay('keySignatureText', $event)
          "
        />
        <SettingsToggle
      ...
      >
        ...
        <SettingsRange
          ...
          :description="
            t(
              'advancedDebug.notation.layout.keySignatureWidthPerAlterationHint',
            )
          "
          :min="20"
          :max="500"
          :step="10"
          @update:model-value="
            updateNotationLayout('keySignatureWidthPerAlteration', $event)
          "
        />
        <SettingsRange
      ...
      >
        ...
        <SettingsColorPicker
          ...
          @update:model-value="
            updateNotationStyle('noteHighlightColor', $event)
          "
        />
        <SettingsRange
      ...
      >
        ...
        <template v-if="waterfallSettings.background.fluidAdvanced">
          ...
          <SettingsRange
            ...
            :description="
              t('advancedDebug.waterfall.fluid.flowPersistenceHint')
            "
            :min="0"
            :max="1"
            :step="0.05"
      ...
      >
        ...
        <SettingsSelect
          ...
          @update:model-value="
            updateWaterfallKb('synthesiaFlowDirection', $event)
          "
        />
      </SettingsCollapse>
      ...
      >
        <div class="py-2.5">
          ...
          <div
            v-if="waterfallSettings.midiFile.selectedTracks.length"
      ...
      >
        ...
        <SettingsRange
          ...
          :step="0.001"
          @update:model-value="
            updateEnvelope('modulationEnvelope', 'attack', $event)
          "
        />
        <SettingsRange
          ...
          :step="0.01"
          @update:model-value="
            updateEnvelope('modulationEnvelope', 'decay', $event)
          "
        />
        <SettingsRange
          ...
          :step="0.05"
          @update:model-value="
            updateEnvelope('modulationEnvelope', 'sustain', $event)
          "
        />
        <SettingsRange
          ...
          :step="0.01"
          @update:model-value="
            updateEnvelope('modulationEnvelope', 'release', $event)
          "
        />
      </SettingsCollapse>
    </div>
