    ...
    <div class="card bg-base-100 shadow-sm w-full">
      <div class="card-body items-center text-center p-6">
        ...
        <p class="text-base-content/70">
          ...
          <a @click.prevent="openLink('https://ljas.fr')" class="text-primary hover:underline cursor-pointer">
    ...
    <div class="card bg-base-100 shadow-sm w-full">
      <div class="card-body p-6">
        <p class="text-base-content/70">
          ...
          <a @click.prevent="openLink('https://www.tobias-erichsen.de/software/loopmidi.html')"
            class="text-primary hover:underline cursor-pointer">
            {{ t("settings.aboutSettings.loopMidi") }}

          </a>
          <a class="text-base-content/70">{{ t("settings.aboutSettings.or") }}</a>
          <a @click.prevent="openLink('https://github.com/microsoft/MIDI')"
            class="text-primary hover:underline cursor-pointer">
        ...
        <div class="card-actions justify-end mt-4">
          <a @click="openLink('https://www.tobias-erichsen.de/software/loopmidi.html')"
        ...
        <div class="card-actions justify-end mt-4">
          <a @click="openLink('https://github.com/microsoft/MIDI')"
            class="btn btn-outline cursor-pointer">
            <Icon name="midi" size="16" />
