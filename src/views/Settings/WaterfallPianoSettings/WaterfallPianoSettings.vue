<template>
  <SettingsSection :show-reset="false">
    ...
    <div class="space-y-3">
      ...
      <!-- 视觉高级 -->
      <SettingsCollapse
        :title="t('waterfallPiano.settingsGroups.visualAdvanced')"
        :default-open="false"
      >
        <SettingsRange
      ...
      <!-- 键盘高级 -->
      <SettingsCollapse
        :title="t('waterfallPiano.settingsGroups.keyboardAdvanced')"
        :default-open="false"
      >
        <SettingsColorPicker
      ...
      <!-- 音频高级 -->
      <SettingsCollapse
        :title="t('waterfallPiano.settingsGroups.audioAdvanced')"
        :default-open="false"
      >
        <SettingsRange
      ...
      <!-- 背景高级 -->
      <SettingsCollapse
        :title="t('waterfallPiano.settingsGroups.backgroundAdvanced')"
        :default-open="false"
      >
        <!-- 自定义图片背景 -->
      ...
      <!-- 粒子物理效果 -->
      <SettingsCollapse
        :title="t('waterfallPiano.settingsGroups.particlePhysics')"
        :default-open="false"
      >
        <!-- 粒子/混合模式额外设置 -->
