<template>
  <g :class="minorClasses" @click="handleClick">
    <path
      class="sector"
      :d="
        drawSection(
...
const minorClasses = computed(() => [
  "key",
  "key--minor",
  { "key--isMainSection": isMainSection("minor", props.config) },
  ...
  },
  {
    "key--active":
      props.config.highlightSector === "notes"
        ...
        : isChordPressed(props.label[0], "minor", props.chord, props.config),
  },
